 ...
 */
final class Version20190702125839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD hide_identity TINYINT(1) DEFAULT NULL, ADD hide_amount TINYINT(1) DEFAULT NULL, CHANGE participant_id participant_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment DROP hide_identity, DROP hide_amount, CHANGE participant_id participant_id INT NOT NULL');
